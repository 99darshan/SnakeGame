...
function displayFruit(xPos, yPos){
    ...
    switch(currentFruit){
        case "apple":
            document.getElementById('fruit').innerHTML = '<img src="assets/images/apple.png" alt="apple">';
            break;
        case "carrot":
            document.getElementById('fruit').innerHTML = '<img src="assets/images/carrot.png" alt="carrot">';                
            break;
        case "beer":
            document.getElementById('fruit').innerHTML = '<img src="assets/images/beer.png" alt="beer">';
            break;
    }
